...
import { Container } from '@agent-router/backend-runtime/di';
...
// `@agent-router/backend-data/dao` module. `vi.mock` factories cannot reference
...
vi.mock('@agent-router/backend-data/dao', () => ({
