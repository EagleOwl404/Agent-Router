...
import { runScheduledTasks } from '@agent-router/background/scheduled';
import { CronTasksWorker } from '@agent-router/background/CronTasksWorker';
...
describe('scheduled tasks', () => {
  it('prunes expired tokens', async () => {
    ...
    const svc = new (await import('@agent-router/backend-services/auth')).TokenService({ DB: db });
